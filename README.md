...
Windows 10/11, çalışan Logitech G HUB, Node.js 20+ ve pnpm gerekir.
...
2. Kodda değişiklik yaptıktan sonra `pnpm build:update` çalıştırın.
...
`pnpm test` pil olaylarını ve güncelleme paketinin doğrulanmasını sınar. Derlenen `dist/` dosyaları Git'e eklenmez; `updates/app.cjs` eklenir.
